  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-2xl mx-auto px-6 py-16 md:py-24">
            ...
            <div className="flex items-center gap-3">
              ...
              <p className="text-sm md:text-lg text-neutral-600 font-medium leading-relaxed">
                ...
                <a
                  ...
                  className="text-neutral-600 hover:text-neutral-700 transition-colors underline"
                >
                  {`Butternut Box`}
                </a>
              </p>
        ...
        <main className="space-y-20">
          ...
          <section>
            ...
            <div className="space-y-8">
              <div className="group border-b border-neutral-200 pb-8">
                <div className="flex items-start justify-between mb-2">
                  <h3 className="text-lg font-medium text-neutral-900">
                    ...
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-neutral-900 hover:text-neutral-700 transition-colors underline"
                    >
                      Butternut Box
                    </a>
                  </h3>
              ...
              <div className="group border-b border-neutral-200 pb-8">
                ...
                <p className="text-neutral-600 mb-2">Front-End Developer</p>
              ...
              <div className="group">
                ...
                <p className="text-neutral-600 mb-2">Web Designer</p>
                <p className="text-neutral-500 text-sm leading-relaxed">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 gap-4 text-neutral-700">
              <div>
                <h3 className="font-medium text-neutral-900 mb-2">Front-End</h3>
              ...
              <div>
                <h3 className="font-medium text-neutral-900 mb-2">Tools</h3>
                <ul className="text-sm space-y-1 text-neutral-600">
                  <li>Git & GitHub</li>
                  <li>Launch Darkly</li>
                  <li>Figma</li>
        ...
        <footer className="mt-32 pt-8 border-t border-neutral-200 flex items-center justify-between">
          ...
          <p className="text-sm text-neutral-400">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-neutral-400 hover:text-neutral-500 transition-colors underline"
            >
              Bolt
            </a>
          </p>
